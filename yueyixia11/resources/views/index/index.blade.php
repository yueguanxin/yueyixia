<?php
	...
	// print_r($_SESSION['token']['access_token']);die;
?>
<!DOCTYPE html>
<html><head>
...
<meta content="W18pFsbd2cZXfAGaC0Tf+cMxc4m77Mqc9SnWWp8MUc4=" name="csrf-token">
    <!--[if lte IE 8]>
    ...
    <script src="js/j.js" async="" type="text/javascript"></script><script src="js/tracker_ex.js" async=""></script><script src="js/tracker.js" async=""></script><script src="js/analytics.js" async=""></script><script src="js/hm.js"></script><script type="text/javascript">
  var _hmt = _hmt || [];
  (function() {
...
<div class="home-page">
  ...
  <h1 class="home-logo">
    <a href="http://www.fishtrip.cn/">
      <img alt="大鱼自助游" src="img/shouye/home-logo-blue.png" title="大鱼自助游">
</a>  </h1>
</div>
  ...
  <?php
	if(empty(session('name'))&&empty($_SESSION['token']['access_token'])&&empty($_SESSION['nickname'])){
  ?>
  ...
  <a class="umenu__button user-avatar dropdown-toggle header__link" data-toggle="dropdown">
    <img alt="小鱼儿441243495号" class="uavatar__pic" src="img/shouye/avatar-default-small-2f53ef89faea912409d250f342324aba.png" height="36" width="36">
	<?php
  ...
  ?>
  <span class="uavatar__text"><?php echo $user_message['screen_name']?></span>
  <?php  }else if(!empty($_SESSION['nickname'])){ ?>
	<span class="uavatar__text"><?php echo $_SESSION['nickname']?></span>
	<?php }else{ ?>
  ...
  <ul class="dropdown-menu umenu__menu" role="menu">
    ...
    <li>
      <a href="http://www.fishtrip.cn/logout">退出</a>
    </li>
  </ul>
</div>
...
<div class="theme-popover-mask"></div>
  ...
  <form accept-charset="UTF-8" action="/search" class="nsearch__wrap nsearch__form" method="get"><div style="margin:0;padding:0;display:inline"><input name="utf8" value="✓" type="hidden"></div>
    ...
    <input class="nsearch__text jnsearch__input" data-placeholder="搜索或选择目的地，预订特色住宿" id="q" name="q" value="搜索或选择目的地，预订特色住宿" type="text">
    ...
    <div class="home-daily-discount-card">
      <div class="hddcard__img daily-discount-img">
        <a href="http://www.fishtrip.cn/houses/hm9569497944/" class="ddimg__link" target="_blank">
          <img alt="九份金瓜石101" src="img/shouye/house-145826730944979411.jpg" title="九份金瓜石101" height="330">
</a>
        ...
        <li class="ddinfo__other">
          ...
          台湾 九份
              <div class="pull-right daily-discount-time">
                仅剩7单 &nbsp;&nbsp;
                距结束<span class="ddtime__countdown js-home-daily-countdown" data-remaining_second="81302">21:11:15</span>
              </div>
    ...
    <div class="home-daily-discount-card">
      <div class="hddcard__img daily-discount-img">
        <a href="http://www.fishtrip.cn/houses/hm10111332671/" class="ddimg__link" target="_blank">
          <img alt="波斯菊乐活馆" src="img/shouye/41712e8a8acdc297e3402f228e20e14bfdd72d6e.jpg" title="波斯菊乐活馆" height="330">
</a>
          <div class="ddimg__discount-tag discount-tag">
            <span class="dtag__text">每日特惠</span> &nbsp;<span class="dtag__rate">7.9</span><span class="dtag__text">折</span>
          </div>
    ...
    <div class="home-daily-discount-card">
      <div class="hddcard__img daily-discount-img">
        <a href="http://www.fishtrip.cn/houses/hm9410167656/" class="ddimg__link" target="_blank">
          <img alt="花莲东方之星民宿" src="img/shouye/house-145760829123949356.jpg" title="花莲东方之星民宿" height="330">
</a>
          <div class="ddimg__discount-tag discount-tag">
            <span class="dtag__text">每日特惠</span> &nbsp;<span class="dtag__rate">7.9</span><span class="dtag__text">折</span>
          </div>
...
<!--         <div class="had__wrap">
  ...
  <div class="hpcard__img">
    <a href="http://www.fishtrip.cn/collections/2582-changdayeyaohaohaowanshui/" target="_blank">
      <img alt="长大也要好好玩水" src="img/shouye/material-145698094712410550.jpg" title="大鱼-长大也要好好玩水" height="330" width="370">
</a>  </div>
  ...
  <div class="hpcard__img">
    <a href="http://www.fishtrip.cn/collections/2480-qingmingqutaibei-huainenzenmewan/" target="_blank">
      <img alt="四月春浪 摇滚台北！" src="img/shouye/material-145631365860824424.jpg" title="大鱼-四月春浪 摇滚台北！" height="330" width="370">
</a>  </div>
  <div class="hpcard__title">
  ...
  <div class="hpcard__img">
    <a href="http://www.fishtrip.cn/collections/139-shuangchenggushi-duoqingmangu-wenyiqingmai/" target="_blank">
      <img alt="萨瓦迪卡，跟泰国Say Hi" src="img/shouye/material-145328437766626255.jpg" title="大鱼-萨瓦迪卡，跟泰国Say Hi" height="330" width="370">
</a>  </div>
  <div class="hpcard__title">
  ...
  <div class="hpcard__location">
      ...
      <div class="hsection__content home-explore-cards fishui-layout-triple">
        <a href="http://www.fishtrip.cn/hunter/" target="_blank" class="fltriple__item hecards__hunter">
          <div class="home-explore-card--hunter home-explore-card">
            ...
            <div class="hecard__icon">
              <img alt="发现" src="img/shouye/explore-hunter-icon.png" title="大鱼-发现">
            </div>
        ...
        <a href="http://www.fishtrip.cn/fishcafe/" target="_blank" class="fltriple__item fltriple__item--last hecards__cafe">
          <div class="home-explore-card--cafe home-explore-card">
            ...
            <div class="hecard__icon">
              <img alt="畅谈" src="img/shouye/explore-cafe-icon.png" title="大鱼-畅谈">
            </div>
            <div class="hecard__title">
              <span>大鱼咖啡</span><br>
              FishCafé<br>
      ...
      <div class="hsection__content fishui-layout-two hmsection__container">
        <div class="fltwo__item home-media">
          <div class="hmedia__brand hmedia__brand--cctv">
            <img alt="Brand-cctv-gray-v2" src="img/shouye/brand-cctv-gray-v2.png">
          </div>
        ...
        <div class="fltwo__item fltwo__item--last home-media">
          <div class="hmedia__brand hmedia__brand--36kr">
            <img alt="Brand-36kr-gray-v2" src="img/shouye/brand-36kr-gray-v2.png">
          </div>
          <div class="hmedia__quote">
    ...
    <div class="hpage__partner home-partner">
      ...
      <span class="hpartner__item">
        <img alt="Brand-taiwan-asso" src="img.jpg">
      </span>
      <span class="hpartner__item">
        <img alt="Brand-sina" src="img/shouye/brand-sina.jpg">
      </span>
      <span class="hpartner__item">
        <img alt="Brand-travel-zoo" src="img/shouye/brand-travel-zoo.jpg">
      </span>
    </div>
  </div>
...
<div class="footer-agent-popover js-footer-agent-popover print-hide">
  ...
  <div class="fapopover__qrcode">
    <img alt="大鱼微信客服" src="img/shouye/footer-weixin-qrcode.png" title="大鱼微信客服" height="106" width="106">
  </div>
