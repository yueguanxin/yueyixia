  ...
  <div class="nhfilter__items">
    ...
    <ul class="nhfilter__item">
      <li class="nhfilter__item-title"><label>价格</label></li>
		&nbsp;&nbsp;&nbsp;<input type="radio" class="money" name="money" id="money" value="50"/><font color="#33ccff">  ￥ 0 - 50 </font>
		&nbsp;&nbsp;<input type="radio" class="money" name="money" id="money" value="100"/><font color="#33ccff">  ￥ 50 - 100 </font>
		&nbsp;&nbsp;<input type="radio" class="money" name="money" id="money" value="150"/><font color="#33ccff">  ￥ 100 - 150 </font>
		&nbsp;&nbsp;<input type="radio" class="money" name="money" id="money" value="200"/><font color="#33ccff">  ￥ 150 - 200 </font>
		&nbsp;&nbsp;<input type="radio" class="money" name="money" id="money" value="250"/><font color="#33ccff">  ￥ 200 - 250 </font>
          ...
          <li class="nhfilter__item-list">
			...
			?>
                ...
                <label>
				  ...
				  <input class="money" id="district_tag_ids_" name="vid" value="<?php echo $v['vid']?>" type="checkbox">
                  <?php echo $v['vname']?>
                </label>
              </span>
			<?php
...
<script type="text/javascript">
	$(function(){
		...
		//收藏
		$(".yicon-heart").click(function(){
			var vid=$(this).attr('value');
			$(this).parent().html('<span class="yicon-heart-red" value="'+vid+'"></span>');
			//alert(vid)
			$.get("/collection_add",{vid:vid},function(date){
				//alert(date)
				if(date=='1'){
					if(confirm("收藏成功！是否查看~~~")){
		...
		//取消收藏
		$(".yicon-heart-red").click(function(){
			alert("111")
			var vid=$(this).attr('value');
			$(this).parent().html('<span class="yicon-heart" value="'+vid+'"></span>');
			//alert(vid)
		})
	})
</script> 
