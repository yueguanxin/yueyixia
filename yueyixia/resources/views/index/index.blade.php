...
<div class="home-page">
  ...
  <h1 class="home-logo">
    <a href="/">
      <img alt="大鱼自助游" src="img/shouye/yueyixia2.png" title="大鱼自助游">
</a>  </h1>
</div>
  ...
  <a class="umenu__button user-avatar dropdown-toggle header__link" data-toggle="dropdown">
    <img alt="约一下" class="uavatar__pic" src="img/userlogo/<?php echo session('uimg')?>" height="36" width="36">
  ...
  <?php }?>
	...
	<div class="theme-popover">
     ...
     <div class="theme-popbod dform" id='ol'>
           <form class="theme-signin" name="loginform" action="/login" method="post">
                <ol >
                     ...
                     <li><a href="javascript:void(0);" onclick='wang()'>忘记密码？</a><input class="btn btn-primary" type="submit" name="submit" value=" 登 录 " /></li>
 ...
 //忘记密码
 function wang(){
	$('#ol').html('<form class="theme-signin" name="loginform" action="wang_pwd" method="post"><ol><li><h3>通过手机号登陆约一下</h3></li> <li><strong>手机号：</strong><input class="ipt" type="text" name="tel"  size="20" placeholder="请输入您的手机号" id="tel"/><span id="sp_tel"></span></li><li><input class="ipt" type="text"  size="15" placeholder="点击获取验证码" onblur="hq()" id="hq1"/><span id="sp_hq"></span> <div class="input-text" data-reactid=".1.1.1.1"><a href="javascript:;" class="input-link disabled" data-reactid=".1.1.1.1.0" onclick="get_mobile_code();">获取验证码</a></div> </li><li></li> <li><input class="btn btn-primary" type="submit" name="submit" value=" 登 录 " /></li></ol></form>');
 }
...
<div class="theme-popover-mask"></div>
  ...
  <form accept-charset="UTF-8" action="/search" class="nsearch__wrap nsearch__form" method="get"><div style="margin:0;padding:0;display:inline"><input name="utf8" value="✓" type="hidden"></div>
    ...
    <input class="nsearch__text jnsearch__input" data-placeholder="搜索或选择目的地，购买景点门票" id="q" name="q" value="搜索或选择目的地，购买景点门票" type="text">
  ...
  <li class="flist__item"><a href="http://www.fishtrip.cn/shareholder/" class="header__link" target="_blank">约一下股东计划</a></li>
    ...
    <div class="home-banner-tips">
      ...
      <span class="hbtips__from">
        图片来自：约一下大股东 岳冠新，<font color="red">刘亚丹</font>，吕慧峰，赵杰
      </span>
 ...
 <!----每日特惠----->
    ...
    <div class="home-daily-discount-card">
      <div class="hddcard__img daily-discount-img">
        <a href="/details?vid=<?php echo $vv['vid']?>" class="ddimg__link" target="_blank">
          <img alt="九份金瓜石101" src="img/img/<?php echo $vv['vimg']?>" title="九份金瓜石101" height="330">
</a>
      ...
      <ul class="hddcard__info daily-discount-info">
        <li class="ddinfo__title">
          <a href="/details?vid=<?php echo $vv['vid']?>" target="_blank"><?php echo $vv['vname']?></a>
          <div class="pull-right ddinfo__title--price">
            <span class="ddinfo__title--small">¥</span> <span class="ddinfo__title--big"><?php echo $vv['vstartprice']?></span><span class="ddinfo__title--small">起</span>
          </div>
        </li>
...
<!--         <div class="had__wrap">
  ...
  <div class="hpcard__img">
    <a href="/details?vid={{ $v['vid'] }}" target="_blank">
      <img alt="{{ $v['vname'] }}" src="img/img/{{ $v['vimg'] }}" title="{{ $v['vname'] }}" height="330" width="370">
</a>  </div>
  <div class="hpcard__title">
    <a href="/details?vid={{ $v['vid'] }}" target="_blank">{{ $v['vname'] }}</a>
  </div>
