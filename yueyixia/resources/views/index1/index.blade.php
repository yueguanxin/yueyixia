...
<div class="home-page">
  ...
  <h1 class="home-logo">
    <a href="/">
      <img alt="大鱼自助游" src="img/img/yueyixia1.png" title="大鱼自助游" width="150" height="100">
</a>  </h1>
</div>
           ...
           <form class="theme-signin" name="loginform" action="/login" method="post">
                <ol>
                     ...
                     <li><strong>密码：</strong><input class="ipt" type="password" name="pwd"  size="20" /></li>
						...
						<li><input type="text" name="captcha" class="ipt" >
...
<div class="theme-popover-mask"></div>
  ...
  <li class="flist__item"><a href="http://www.fishtrip.cn/hunter/" class="header__link" target="_blank">旅行猎人</a></li>
  <li class="flist__item"><a href="http://www.fishtrip.cn/shareholder/" class="header__link" target="_blank">股东计划</a></li>
</ul>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-body">
        ...
        <p class="famodal__title">下载约一下APP，下单立减20元</p>
